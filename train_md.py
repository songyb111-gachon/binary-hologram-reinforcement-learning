...
from env_md import BinaryHologramEnv
...
class BinaryNet(nn.Module):
    def __init__(self, num_hologram, final='Sigmoid', in_planes=3,
        ...
        def TRB2d(in_channels, out_channels, kernel_size=2, stride=2, bias=True, relu=True, bn=True):
            ...
            cbr = nn.Sequential(*layers)  # *으로 list unpackingMultiDiscrete
...
# 저장할 폴더 경로 설정
save_dir = "./1-6-md-ppo_MlpPolicy_models/"  # 모델 저장 디렉토리
...
if resume_training and os.path.exists(ppo_model_path):
    ...
    ppo_model = PPO(
        ...
        max_grad_norm=0.5,
        ent_coef=0.01,
        tensorboard_log="./1-6-md-ppo_MultiInputPolicy/",
        #policy_kwargs={
